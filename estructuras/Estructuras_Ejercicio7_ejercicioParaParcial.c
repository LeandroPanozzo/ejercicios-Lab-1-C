...
int main(int argc, char *argv[]) {
	...
	for (i = 0; i < ELE; i++) {
		printf("Artista %d\n", i);
		printf("Nombre: ");
		fgets(Artista[i].nombre, sizeof(Artista[i].nombre), stdin);
		printf("\n");
		printf("Apellido: ");
		fgets(Artista[i].apellido, sizeof(Artista[i].apellido), stdin);
		printf("\n");
		printf("DNI: ");
	...
	for (i = 0; i < ELE; i++) {
		printf("Artista %d\n", i);
		printf("Título: ");
		fgets(exito[i].titulo, sizeof(exito[i].titulo), stdin);
		printf("\n");
